export const About = () => {
  ...
  return (
    <section
      id="about"
      className="min-h-screen flex items-center just-center py-20"
    >
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="glass rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
          <p className="text-gray-300 mb-6">
            Tenho foco em Java com Spring Boot no back-end e React no front-end,
            aplicando meus conhecimentos em projetos práticos que compõem meu
            portfólio.
          </p>
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                <h4 className="font-semibold">
                  Assistente de Help Desk em SOC Software de SST (2024-Present)
                </h4>
                <p>
