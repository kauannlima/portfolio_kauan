  ...
  return (
    ...
    >
      <div className="text-center z-10 px-4">
        <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 mb-6 bg-clip-text text-transparent leading-right ">
          Olá, eu sou o Kauan Lima
        </h1>

        <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
          Sou desenvolvedor full stack, formado em Análise e Desenvolvimento de
          Sistemas. Tenho foco em Java com Spring Boot no back-end e React no
