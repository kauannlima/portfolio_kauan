        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                EncurtaDev é uma aplicação web para encurtar URLs de forma
                prática e eficiente. Conta com geração automática de QR Codes,
                interface simples e integração com o back-end para processamento
                e armazenamento das URLs.
              </p>
              <div className="flex flex-wrap gap-2 mt-2">
                {[
                  "React",
          ...
          hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                ...
                oferecendo funcionalidades como navegação por produtos, adição
                ao carrinho e finalização de compras. Foi meu primeiro projeto
                utilizando o framework Struts, com o front-end integrado ao
                back-end por meio de páginas JSP, marcando uma nova etapa na
                minha evolução com aplicações Java baseadas em MVC tradicional.
              </p>
              <div className="flex flex-wrap gap-2 mt-2">
          ...
          hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                ...
                despesas. Foi meu primeiro projeto completo integrando front-end
                e back-end, utilizando técnicas mais antigas de conexão entre as
